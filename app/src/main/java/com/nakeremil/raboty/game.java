...
import com.nakeremil.raboty.databinding.ActivityGameBinding;
...
public class game extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cheeseAnim.setInterpolator(null);
        ...
        binding.getRoot().setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (attempt > 0 && !isAnimate) {
                    ...
                    animKnife.setInterpolator(null);
                    animKnife.start();
                    ...
                    animKnife.addListener(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(Animator animation) {
                            ...
                            knifeAnimators[knifeAnimators.length - attempt - 1].setInterpolator(null);
                            ...
                            for (int i = 0; i < knifeAnimators.length; ++i) {
                                if (knifeAnimators[knifeAnimators.length - i - 1] != null) {
                                    ...
                                    knifeAnimators[knifeAnimators.length - i - 1].setInterpolator(null);
                            ...
                            Runnable run = new Runnable() {
                                ...
                                public void run() {
                                    for (int i = 0; i < knifeAnimators.length; ++i) {
                                        if (knifeAnimators[knifeAnimators.length - i - 1] != null && (dialog == null || !dialog.isShowing())) {
                            ...
                            final Animation animShake = AnimationUtils.loadAnimation(game.this, R.anim.shake);
                            binding.gameCheese.startAnimation(animShake);
                            for (int i = 0; i < knives.length - attempt; ++i) {
                                knives[i].startAnimation(animShake);
